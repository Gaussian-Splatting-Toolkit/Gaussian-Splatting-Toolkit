...
namespace glm {
template <> GLM_FUNC_QUALIFIER float next_float(float x) {
...
template <> GLM_FUNC_QUALIFIER double next_float(double x) {
#if GLM_HAS_CXX11_STL
...
template <typename T> GLM_FUNC_QUALIFIER T next_float(T x, int ULPs) {
...
template <typename T> GLM_FUNC_QUALIFIER T prev_float(T x, int ULPs) {
  GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559,
