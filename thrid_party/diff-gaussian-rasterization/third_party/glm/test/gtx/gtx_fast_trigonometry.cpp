...
taylorSeriesNewCos(glm::vec<L, T, Q> const &x) {
...
template <length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER glm::vec<L, T, Q>
taylorSeriesNewCos6(glm::vec<L, T, Q> const &x) {
  glm::vec<L, T, Q> const Powed2(x * x);
  glm::vec<L, T, Q> const Powed4(Powed2 * Powed2);
  glm::vec<L, T, Q> const Powed6(Powed4 * Powed2);
...
template <length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER glm::vec<L, T, Q>
deterministic_fmod(glm::vec<L, T, Q> const &x, T y) {
  return x - y * trunc(x / y);
}

template <length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER glm::vec<L, T, Q>
fastCosDeterminisctic(glm::vec<L, T, Q> const &x) {
...
template <length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER glm::vec<L, T, Q>
taylorSeriesRefCos(glm::vec<L, T, Q> const &x) {
