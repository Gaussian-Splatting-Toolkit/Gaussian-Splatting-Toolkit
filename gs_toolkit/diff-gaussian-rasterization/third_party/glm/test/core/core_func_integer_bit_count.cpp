...
int main() {
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (pop0(test[i]) != test[i + 1])
        error(test[i], pop0(test[i]));
    }
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (pop1(test[i]) != test[i + 1])
        error(test[i], pop1(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (pop2(test[i]) != test[i + 1])
        error(test[i], pop2(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (pop3(test[i]) != test[i + 1])
        error(test[i], pop3(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (pop4(test[i]) != test[i + 1])
        error(test[i], pop4(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (pop5(test[i]) != test[i + 1])
        error(test[i], pop5(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (pop5a(test[i]) != test[i + 1])
        error(test[i], pop5a(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (pop6(test[i]) != test[i + 1])
        error(test[i], pop6(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if ((test[i] & 0xffffff00) == 0)
        if (pop7(test[i]) != test[i + 1])
          error(test[i], pop7(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if ((test[i] & 0xffffff80) == 0)
        if (pop8(test[i]) != test[i + 1])
          error(test[i], pop8(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if ((test[i] & 0xffff8000) == 0)
        if (pop9(test[i]) != test[i + 1])
          error(test[i], pop9(test[i]));
    }
  TimestampEnd = std::clock();
