...
int test_adjugate() {
  ...
  // mat2
  const glm::mat2 m2(2, 3, 1, 5);

  const glm::mat2 eam2(5, -3, -1, 2);
  ...
  // mat3
  const glm::mat3 m3(2, 3, 3, 1, 5, 4, 4, 6, 8);

  const glm::mat3 eam3(16, -6, -3, 8, 4, -5, -14, 0, 7);
  ...
  // mat4
  const glm::mat4 m4(2, 3, 3, 1, 1, 5, 4, 3, 4, 6, 8, 5, -2, -3, -3, 4);

  const glm::mat4 eam4(97, -30, -15, 17, 45, 20, -25, 5, -91, 0, 35, -21, 14, 0,
                       0, 14);
