...
/// Returns whether vector components values are within an interval. A open
/// interval excludes its endpoints, and is denoted with square brackets.
///
...
/// Returns whether vector components values are within an interval. A closed
/// interval includes its endpoints, and is denoted with square brackets.
///
/// @tparam L Integer between 1 and 4 included that qualify the dimension of the
/// vector
/// @tparam T Floating-point or integer scalar types
