...
/// @ingroup core
///
/// Provides GLSL functions to pack and unpack half, single and double-precision
/// floating point values into more compact integer types.
///
...
/// Returns a double-qualifier value obtained by packing the components of v
