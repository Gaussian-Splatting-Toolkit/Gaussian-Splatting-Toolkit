...
struct _swizzle_base1<4, float, Q, E0, E1, E2, E3, true>
...
template <qualifier Q, int E0, int E1, int E2, int E3>
struct _swizzle_base1<4, int, Q, E0, E1, E2, E3, true>
    : public _swizzle_base0<int, 4> {
...
template <qualifier Q, int E0, int E1, int E2, int E3>
struct _swizzle_base1<4, uint, Q, E0, E1, E2, E3, true>
    : public _swizzle_base0<uint, 4> {
...
template <qualifier Q> struct compute_vec4_add<float, Q, true> {
  static vec<4, float, Q> call(vec<4, float, Q> const &a,
...
#if GLM_ARCH & GLM_ARCH_AVX_BIT
template <qualifier Q> struct compute_vec4_add<double, Q, true> {
  static vec<4, double, Q> call(vec<4, double, Q> const &a,
...
template <qualifier Q> struct compute_vec4_sub<float, Q, true> {
  static vec<4, float, Q> call(vec<4, float, Q> const &a,
                               vec<4, float, Q> const &b) {
    vec<4, float, Q> Result;
...
#if GLM_ARCH & GLM_ARCH_AVX_BIT
template <qualifier Q> struct compute_vec4_sub<double, Q, true> {
  static vec<4, double, Q> call(vec<4, double, Q> const &a,
                                vec<4, double, Q> const &b) {
    vec<4, double, Q> Result;
...
template <qualifier Q> struct compute_vec4_mul<float, Q, true> {
  static vec<4, float, Q> call(vec<4, float, Q> const &a,
                               vec<4, float, Q> const &b) {
    vec<4, float, Q> Result;
...
#if GLM_ARCH & GLM_ARCH_AVX_BIT
template <qualifier Q> struct compute_vec4_mul<double, Q, true> {
  static vec<4, double, Q> call(vec<4, double, Q> const &a,
                                vec<4, double, Q> const &b) {
    vec<4, double, Q> Result;
...
template <qualifier Q> struct compute_vec4_div<float, Q, true> {
  static vec<4, float, Q> call(vec<4, float, Q> const &a,
                               vec<4, float, Q> const &b) {
    vec<4, float, Q> Result;
...
#if GLM_ARCH & GLM_ARCH_AVX_BIT
template <qualifier Q> struct compute_vec4_div<double, Q, true> {
  static vec<4, double, Q> call(vec<4, double, Q> const &a,
                                vec<4, double, Q> const &b) {
    vec<4, double, Q> Result;
...
template <> struct compute_vec4_div<float, aligned_lowp, true> {
  static vec<4, float, aligned_lowp>
  call(vec<4, float, aligned_lowp> const &a,
...
template <qualifier Q> struct compute_vec4_equal<float, Q, false, 32, true> {
...
template <qualifier Q> struct compute_vec4_equal<int, Q, true, 32, true> {
...
template <qualifier Q> struct compute_vec4_nequal<float, Q, false, 32, true> {
  static bool call(vec<4, float, Q> const &v1, vec<4, float, Q> const &v2) {
    return _mm_movemask_ps(_mm_cmpneq_ps(v1.data, v2.data)) != 0;
  }
};
...
#if GLM_ARCH & GLM_ARCH_SSE41_BIT
template <qualifier Q> struct compute_vec4_nequal<int, Q, true, 32, true> {
  static bool call(vec<4, int, Q> const &v1, vec<4, int, Q> const &v2) {
...
vec<4, detail::int64, aligned_lowp>::vec(detail::int64 _s)
    : data(_mm256_set1_epi64x(_s)) {}

template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, detail::int64, aligned_mediump>::vec(detail::int64 _s)
    : data(_mm256_set1_epi64x(_s)) {}

template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, detail::int64, aligned_highp>::vec(detail::int64 _s)
    : data(_mm256_set1_epi64x(_s)) {}
#endif
...
template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, int, aligned_lowp>::vec(int _x, int _y,
                                                                int _z, int _w)
...
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, int, aligned_mediump>::vec(int _x, int _y, int _z, int _w)
    : data(_mm_set_epi32(_w, _z, _y, _x)) {}

template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, int, aligned_highp>::vec(int _x, int _y,
                                                                 int _z, int _w)
    : data(_mm_set_epi32(_w, _z, _y, _x)) {}
...
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, float, aligned_lowp>::vec(int _x, int _y, int _z, int _w)
    : data(_mm_cvtepi32_ps(_mm_set_epi32(_w, _z, _y, _x))) {}

template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, float, aligned_mediump>::vec(int _x, int _y, int _z, int _w)
    : data(_mm_cvtepi32_ps(_mm_set_epi32(_w, _z, _y, _x))) {}

template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
vec<4, float, aligned_highp>::vec(int _x, int _y, int _z, int _w)
    : data(_mm_cvtepi32_ps(_mm_set_epi32(_w, _z, _y, _x))) {}
} // namespace glm
...
template <qualifier Q> struct compute_vec4_add<uint, Q, true> {
  static vec<4, uint, Q> call(vec<4, uint, Q> const &a,
                              vec<4, uint, Q> const &b) {
    vec<4, uint, Q> Result;
...
template <qualifier Q> struct compute_vec4_add<int, Q, true> {
...
template <qualifier Q> struct compute_vec4_sub<uint, Q, true> {
  static vec<4, uint, Q> call(vec<4, uint, Q> const &a,
                              vec<4, uint, Q> const &b) {
    vec<4, uint, Q> Result;
...
template <qualifier Q> struct compute_vec4_sub<int, Q, true> {
  static vec<4, int, Q> call(vec<4, int, Q> const &a, vec<4, int, Q> const &b) {
    vec<4, int, Q> Result;
...
template <qualifier Q> struct compute_vec4_mul<uint, Q, true> {
  static vec<4, uint, Q> call(vec<4, uint, Q> const &a,
                              vec<4, uint, Q> const &b) {
    vec<4, uint, Q> Result;
...
template <qualifier Q> struct compute_vec4_mul<int, Q, true> {
  static vec<4, int, Q> call(vec<4, int, Q> const &a, vec<4, int, Q> const &b) {
    vec<4, int, Q> Result;
...
template <qualifier Q> struct compute_vec4_div<float, Q, true> {
  static vec<4, float, Q> call(vec<4, float, Q> const &a,
     ...
     *
     * Note: The precision usually improves with two interactions, but more than
     * two iterations are not helpful. */
...
template <qualifier Q> struct compute_vec4_equal<uint, Q, false, 32, true> {
...
template <qualifier Q> struct compute_vec4_equal<int, Q, false, 32, true> {
  static bool call(vec<4, int, Q> const &v1, vec<4, int, Q> const &v2) {
...
template <qualifier Q> struct compute_vec4_nequal<uint, Q, false, 32, true> {
  static bool call(vec<4, uint, Q> const &v1, vec<4, uint, Q> const &v2) {
    return !compute_vec4_equal<uint, Q, false, 32, true>::call(v1, v2);
  }
};

template <qualifier Q> struct compute_vec4_nequal<int, Q, false, 32, true> {
  static bool call(vec<4, int, Q> const &v1, vec<4, int, Q> const &v2) {
