...
namespace glm {
template <> GLM_FUNC_QUALIFIER float nextFloat(float x) {
...
template <> GLM_FUNC_QUALIFIER double nextFloat(double x) {
#if GLM_HAS_CXX11_STL
...
template <typename T> GLM_FUNC_QUALIFIER T nextFloat(T x, int ULPs) {
...
template <typename T> GLM_FUNC_QUALIFIER T prevFloat(T x, int ULPs) {
  GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559,
