...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> eulerAngleX(T const &angleX) {
  ...
  return mat<4, 4, T, defaultp>(T(1), T(0), T(0), T(0), T(0), cosX, sinX, T(0),
                                T(0), -sinX, cosX, T(0), T(0), T(0), T(0),
                                T(1));
}
...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> eulerAngleY(T const &angleY) {
  ...
  return mat<4, 4, T, defaultp>(cosY, T(0), -sinY, T(0), T(0), T(1), T(0), T(0),
                                sinY, T(0), cosY, T(0), T(0), T(0), T(0), T(1));
}
...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> eulerAngleZ(T const &angleZ) {
  ...
  return mat<4, 4, T, defaultp>(cosZ, sinZ, T(0), T(0), -sinZ, cosZ, T(0), T(0),
...
derivedEulerAngleX(T const &angleX, T const &angularVelocityX) {
  ...
  return mat<4, 4, T, defaultp>(T(0), T(0), T(0), T(0), T(0), -sinX, cosX, T(0),
                                T(0), -cosX, -sinX, T(0), T(0), T(0), T(0),
                                T(0));
}
...
derivedEulerAngleY(T const &angleY, T const &angularVelocityY) {
  ...
  return mat<4, 4, T, defaultp>(-sinY, T(0), -cosY, T(0), T(0), T(0), T(0),
                                T(0), cosY, T(0), -sinY, T(0), T(0), T(0), T(0),
                                T(0));
}
...
derivedEulerAngleZ(T const &angleZ, T const &angularVelocityZ) {
  ...
  return mat<4, 4, T, defaultp>(-sinZ, cosZ, T(0), T(0), -cosZ, -sinZ, T(0),
...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> eulerAngleXY(T const &angleX,
  ...
  return mat<4, 4, T, defaultp>(cosY, -sinX * -sinY, cosX * -sinY, T(0), T(0),
                                cosX, sinX, T(0), sinY, -sinX * cosY,
                                cosX * cosY, T(0), T(0), T(0), T(0), T(1));
}
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleXZX(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleXYX(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleYXY(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleYZY(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleZYZ(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleZXZ(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleXZY(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleYZX(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleZYX(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
...
template <typename T>
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp>
eulerAngleZXY(T const &t1, T const &t2, T const &t3) {
  T c1 = glm::cos(t1);
  T s1 = glm::sin(t1);
  T c2 = glm::cos(t2);
  T s2 = glm::sin(t2);
