...
from gs_toolkit.process_data import (
    metashape_utils,
    polycam_utils,
    process_data_utils,
...
from gs_toolkit.process_data.colmap_converter_to_gstk_dataset import (
...
@dataclass
class ProcessRecord3D(BaseConverterToGSToolkitDataset):
    """Process Record3D data into a gs_toolkit dataset.

    This script does the following:

    1. Scales images to a specified size.
    2. Converts Record3D poses into the gs_toolkit format.
    """
    ...
    def main(self) -> None:
        """Process images into a gs_toolkit dataset."""
...
@dataclass
class ProcessPolycam(BaseConverterToGSToolkitDataset):
    """Process Polycam data into a gs_toolkit dataset.
    ...
    1. Scales images to a specified size.
    2. Converts Polycam poses into the gs_toolkit format.
    """
...
@dataclass
class ProcessMetashape(BaseConverterToGSToolkitDataset, _NoDefaultProcessMetashape):
    """Process Metashape data into a gs_toolkit dataset.
    ...
    1. Scales images to a specified size.
    2. Converts Metashape poses into the gs_toolkit format.
    """
    ...
    def main(self) -> None:
        ...
        if self.eval_data is not None:
            raise ValueError(
                "Cannot use eval_data since cameras were already aligned with Metashape."
            )
...
class ProcessRealityCapture(
    BaseConverterToGSToolkitDataset, _NoDefaultProcessRealityCapture
):
    """Process RealityCapture data into a gs_toolkit dataset.
    ...
    1. Scales images to a specified size.
    2. Converts RealityCapture poses into the gs_toolkit format.
    """
    ...
    def main(self) -> None:
        ...
        if self.eval_data is not None:
            raise ValueError(
                "Cannot use eval_data since cameras were already aligned with RealityCapture."
            )
...
@dataclass
class ProcessODM(BaseConverterToGSToolkitDataset):
    """Process ODM data into a gs_toolkit dataset.

    This script does the following:

    1. Scales images to a specified size.
    2. Converts ODM poses into the gs_toolkit format.
    """
    ...
    def main(self) -> None:
        ...
        if self.eval_data is not None:
            raise ValueError(
                "Cannot use eval_data since cameras were already aligned with ODM."
            )
