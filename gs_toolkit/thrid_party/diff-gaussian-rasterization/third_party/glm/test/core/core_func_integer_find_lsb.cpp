...
int main() {
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz1(test[i]) != test[i + 1])
        error(test[i], ntz1(test[i]));
    }
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz2(test[i]) != test[i + 1])
        error(test[i], ntz2(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz3(test[i]) != test[i + 1])
        error(test[i], ntz3(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz4(test[i]) != test[i + 1])
        error(test[i], ntz4(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz4a(test[i]) != test[i + 1])
        error(test[i], ntz4a(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz6(test[i]) != test[i + 1])
        error(test[i], ntz6(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz6a(test[i]) != test[i + 1])
        error(test[i], ntz6a(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz8(test[i]) != test[i + 1])
        error(test[i], ntz8(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz8a(test[i]) != test[i + 1])
        error(test[i], ntz8a(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz9(test[i]) != test[i + 1])
        error(test[i], ntz9(test[i]));
    }
  TimestampEnd = std::clock();
  ...
  for (std::size_t k = 0; k < Count; ++k)
    for (i = 0; i < n; i += 2) {
      if (ntz10(test[i]) != test[i + 1])
        error(test[i], ntz10(test[i]));
    }
  TimestampEnd = std::clock();
