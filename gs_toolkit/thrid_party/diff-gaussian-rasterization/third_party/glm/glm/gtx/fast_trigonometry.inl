...
// wrapAngle
template <typename T> GLM_FUNC_QUALIFIER T wrapAngle(T angle) {
...
// sin
template <typename T> GLM_FUNC_QUALIFIER T fastSin(T x) {
...
template <length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<L, T, Q> fastAtan(vec<L, T, Q> const &y,
                                         vec<L, T, Q> const &x) {
