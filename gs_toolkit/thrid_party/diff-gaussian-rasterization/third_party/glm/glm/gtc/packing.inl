...
template <length_t L, qualifier Q> struct compute_half {};

template <qualifier Q> struct compute_half<1, Q> {
  ...
  GLM_FUNC_QUALIFIER static vec<1, float, Q>
  unpack(vec<1, uint16, Q> const &v) {
    i16vec1 Unpack;
...
template <qualifier Q> struct compute_half<2, Q> {
  ...
  GLM_FUNC_QUALIFIER static vec<2, float, Q>
  unpack(vec<2, uint16, Q> const &v) {
    i16vec2 Unpack;
    memcpy(&Unpack, &v, sizeof(Unpack));
...
template <qualifier Q> struct compute_half<3, Q> {
  ...
  GLM_FUNC_QUALIFIER static vec<3, float, Q>
  unpack(vec<3, uint16, Q> const &v) {
    i16vec3 Unpack;
    memcpy(&Unpack, &v, sizeof(Unpack));
...
template <qualifier Q> struct compute_half<4, Q> {
...
GLM_FUNC_QUALIFIER vec<L, uintType, Q>
