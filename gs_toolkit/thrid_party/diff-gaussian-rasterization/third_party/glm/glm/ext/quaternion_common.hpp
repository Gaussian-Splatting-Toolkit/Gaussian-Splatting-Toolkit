...
/// Spherical linear interpolation of two quaternions with multiple spins over
/// rotation axis. The interpolation always take the short path when the spin
/// count is positive and long path when count is negative. Rotation is
...
/// @param a Interpolation factor. The interpolation is defined beyond the range
/// [0, 1].
/// @param k Additional spin count. If Value is negative interpolation will be
/// on "long" path.
///
/// @tparam T A floating-point scalar type
