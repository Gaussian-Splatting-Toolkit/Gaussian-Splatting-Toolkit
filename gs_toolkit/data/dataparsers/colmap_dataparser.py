...
from gs_toolkit.cameras.cameras import CAMERA_MODEL_TO_TYPE, Cameras
...
from gs_toolkit.data.utils import colmap_parsing_utils as colmap_utils
from gs_toolkit.process_data.colmap_utils import parse_colmap_camera_params
from gs_toolkit.utils.scripts import run_command
from gs_toolkit.utils.rich_utils import CONSOLE, status
from gs_toolkit.data.utils.dataparsers_utils import (
    ...
    def _setup_downscale_factor(
        ...
        if self._downscale_factor is None:
            ...
            if self._downscale_factor > 1 and not all(
                ...
                if Confirm.ask(
                    "\nWould you like to downscale the images now?",
                    default=False,
                    console=CONSOLE,
                ):
                    # Install the method
