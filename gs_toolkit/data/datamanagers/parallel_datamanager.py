        ...
        while True:
            ...
            while True:
                try:
                    ...
                    CONSOLE.print(
                        "[bold red]Error: Error occured in parallel datamanager queue."
                    )
...
class ParallelDataManager(DataManager, Generic[TDataset]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dataset_type: Type[TDataset] = kwargs.get(
            "_dataset_type", getattr(TDataset, "__default__")
        )
        self.config = config
        self.device = device
        ...
        self.eval_dataparser_outputs: DataparserOutputs = (
