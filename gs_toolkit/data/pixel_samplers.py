...
from gs_toolkit.configs.base_config import (
    InstantiateConfig,
)
from gs_toolkit.data.utils.pixel_sampling_utils import erode_mask
    ...
    def collate_image_dataset_batch_list(
        ...
        if "mask" in batch:
            ...
            for i in range(num_images):
                ...
                if i == num_images - 1:
                    num_rays_in_batch = (
                        num_rays_per_batch - (num_images - 1) * num_rays_in_batch
                    )
