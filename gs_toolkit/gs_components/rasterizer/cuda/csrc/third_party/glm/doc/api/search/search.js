...
function SearchBox(name, resultsPath, inFrame, label) {
  ...
  this.DOMSearchField =
      function() { return document.getElementById("MSearchField"); }

      this.DOMSearchSelect =
          function() { return document.getElementById("MSearchSelect"); }
    ...
    if (searchValue != this.lastSearchValue) // search value has changed
    {
      if (searchValue != "") // non-empty search
      {
        ...
        this.keyTimeout =
            setTimeout(this.name + '.Search()', this.keyTimeoutLength);
...
function SearchResults(name) {
  ...
  this.FindChildElement =
    ...
    return false;
                              ...
                              this.NavChild = function(evt, itemIndex,
                                                       childIndex) {
    var e = (evt) ? evt : window.event; // for IE
    if (e.keyCode == 13)
      return true;
  ...
  for (var e = 0; e < searchData.length; e++) {
    ...
    } else // multiple results
    {
      ...
      for (var c = 0; c < searchData[e][1].length - 1; c++) {
        ...
        setKeyActions(srChild, 'return searchResults.NavChild(event,' + e +
                                   ',' + c + ')');
