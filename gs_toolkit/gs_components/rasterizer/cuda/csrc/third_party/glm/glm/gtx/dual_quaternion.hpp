...
///
/// Defines a templated dual-quaternion type and several dual-quaternion
/// operations.
...
template <typename T, qualifier Q = defaultp> struct tdualquat {
  ...
  GLM_DEFAULTED_FUNC_DECL GLM_CONSTEXPR tdualquat(tdualquat<T, Q> const &d)
      GLM_DEFAULT;
  ...
  GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR
  tdualquat(mat<2, 4, T, Q> const &holder_mat);
  GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR
  tdualquat(mat<3, 4, T, Q> const &aug_mat);

  // -- Unary arithmetic operators --

  GLM_DEFAULTED_FUNC_DECL tdualquat<T, Q> &
  operator=(tdualquat<T, Q> const &m) GLM_DEFAULT;
...
template <typename T, qualifier Q>
GLM_FUNC_DECL vec<3, T, Q> operator*(tdualquat<T, Q> const &q,
                                     vec<3, T, Q> const &v);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL vec<4, T, Q> operator*(tdualquat<T, Q> const &q,
                                     vec<4, T, Q> const &v);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL bool operator==(tdualquat<T, Q> const &q1,
...
template <typename T, qualifier Q>
GLM_FUNC_DECL tdualquat<T, Q> lerp(tdualquat<T, Q> const &x,
