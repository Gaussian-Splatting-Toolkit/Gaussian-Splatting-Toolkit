...
GLM_FUNC_QUALIFIER vec<L, T, Q> nextPowerOfTwo(vec<L, T, Q> const &v) {
  ...
  return detail::compute_ceilPowerOfTwo<
      L, T, Q, std::numeric_limits<T>::is_signed>::call(v);
}
...
GLM_FUNC_QUALIFIER vec<L, T, Q> nextMultiple(vec<L, T, Q> const &Source,
  ...
  return detail::functor2<vec, L, T, Q>::call(nextMultiple, Source,
                                              vec<L, T, Q>(Multiple));
}
...
GLM_FUNC_QUALIFIER vec<L, T, Q> prevMultiple(vec<L, T, Q> const &Source,
  ...
  return detail::functor2<vec, L, T, Q>::call(prevMultiple, Source,
                                              vec<L, T, Q>(Multiple));
}
...
GLM_FUNC_QUALIFIER vec<L, int, Q> findNSB(vec<L, T, Q> const &Source,
  ...
  return detail::functor2_vec_int<L, T, Q>::call(findNSB, Source,
                                                 SignificantBitCount);
}
} // namespace glm
