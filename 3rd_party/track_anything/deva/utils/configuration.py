...
class Configuration:
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument(
            "--ovis_root", help="OVIS data root", default="../OVIS-VOS-train"
        )
        parser.add_argument(
            "--num_workers",
        ...
        parser.add_argument(
            "--s0_lr", help="Initial learning rate", default=2e-5, type=float
        )
        ...
        # Loading
        parser.add_argument(
            "--load_network", help="Path to a pretrained network weights file. "
        )
        parser.add_argument(
            "--load_checkpoint",
