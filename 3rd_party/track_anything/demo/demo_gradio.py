...
def demo_with_text(
    ...
    result_saver = ResultSaver(
        None, None, dataset="gradio", object_manager=deva.object_manager
    )
...
auto_demo_tab = gr.Interface(
    ...
    inputs=[
        ...
        gr.Slider(
            ...
            maximum=256,
            value=64,
            label="Num. points per side for SAM",
            step=1,
        ),
        gr.Slider(
            minimum=10,
        ...
        gr.Slider(
            minimum=384, maximum=1080, value=480, label="Internal resolution", step=1
        ),
        gr.Slider(
            minimum=3,
            maximum=100,
...
if __name__ == "__main__":
    gr.TabbedInterface(
        [text_demo_tab, auto_demo_tab], ["Text prompt", "Automatic"]
    ).launch()
